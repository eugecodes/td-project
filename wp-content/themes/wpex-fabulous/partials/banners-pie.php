   	...
   	<div id="footer-widgets" class="clr">
			...
			if ( get_theme_mod( 'wpex_footer_columns', '4' ) > '1' ) { ?>
				<div class="footer-box <?php echo $wpex_footer_box_class; ?> col col-2">
				  ...
				  <p><a href="http://www.espaciotradem.com/linkeo.php?link=http://www.sillonesrumar.com.ar/" target="_blank"><img src="http://www.trademdesign.com/images/logos/sillones-rumar.jpg" alt="Sillones Rumar" /></a></p>
	  </div><!-- .footer-box -->
			<?php } ?>
			<?php
			// Third Footer Area
			if ( get_theme_mod( 'wpex_footer_columns', '4' ) > '1' ) { ?>
				<div class="footer-box <?php echo $wpex_footer_box_class; ?> col col-3">
				  ...
				  <p><a href="http://www.espaciotradem.com/linkeo.php?link=http://www.littleshade.com/" target="_blank"><img src="http://www.trademdesign.com/images/logos/littleshade.jpg" alt="Macetas La Cioppa" /></a></p>
	  </div><!-- .footer-box -->
			<?php } ?>
			<?php
			// Fourth Footer Area
			if ( get_theme_mod( 'wpex_footer_columns', '4' ) > '1' ) { ?>
				<div class="footer-box <?php echo $wpex_footer_box_class; ?> col col-4">
				  <p><a href="http://www.espaciotradem.com/linkeo.php?link=http://www.renobasolar.com" target="_blank"><img src="http://www.trademdesign.com/images/logos/renoba.jpg" alt="RenoBA Solar" /></a></p>
				  <p><a href="http://www.espaciotradem.com/linkeo.php?link=https://www.facebook.com/maraniadeco" target="_blank"><img src="http://www.trademdesign.com/images/logos/marana.jpg" alt="Maraña" /></a></p>
				  <p><a href="http://www.espaciotradem.com/linkeo.php?link=http://www.colgandocuadros.com.ar/" target="_blank"><img src="http://www.trademdesign.com/images/logos/colgando.jpg" alt="Colgado Cuadros" /></a></p>
	  </div><!-- .footer-box -->
			<?php } ?>
  </div><!-- #footer-widgets -->
</div><!-- #footer -->