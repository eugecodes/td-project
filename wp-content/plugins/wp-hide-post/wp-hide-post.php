...
?>
    <label for="wplp_post_front" class="selectit"><input type="checkbox" id="wplp_post_front" name="wplp_post_front" value="1"<?php checked($wplp_post_front, 1); ?>/>&nbsp;Ocultar en Index</label>
    <input type="hidden" name="old_wplp_post_front" value="<?php echo $wplp_post_front; ?>"/>
    <br />
    <label for="wplp_post_category" class="selectit"><input type="checkbox" id="wplp_post_category" name="wplp_post_category" value="1"<?php checked($wplp_post_category, 1); ?>/>&nbsp;Ocultar en categorías</label>
    <input type="hidden" name="old_wplp_post_category" value="<?php echo $wplp_post_category; ?>"/>
    <br />
    <label for="wplp_post_tag" class="selectit"><input type="checkbox" id="wplp_post_tag" name="wplp_post_tag" value="1"<?php checked($wplp_post_tag, 1); ?>/>&nbsp;Ocultar en página de Tags</label>
    <input type="hidden" name="old_wplp_post_tag" value="<?php echo $wplp_post_tag; ?>"/>
    <br />
    <label for="wplp_post_author" class="selectit"><input type="checkbox" id="wplp_post_author" name="wplp_post_author" value="1"<?php checked($wplp_post_author, 1); ?>/>&nbsp;Ocultar en páginas</label>
    <input type="hidden" name="old_wplp_post_author" value="<?php echo $wplp_post_author; ?>"/>
    <br />
    <label for="wplp_post_archive" class="selectit"><input type="checkbox" id="wplp_post_archive" name="wplp_post_archive" value="1"<?php checked($wplp_post_archive, 1); ?>/>&nbsp;Ocultar en archivos</label>
    <input type="hidden" name="old_wplp_post_archive" value="<?php echo $wplp_post_archive; ?>"/>
    <br />
    <label for="wplp_post_search" class="selectit"><input type="checkbox" id="wplp_post_search" name="wplp_post_search" value="1"<?php checked($wplp_post_search, 1); ?>/>&nbsp;Ocultar en resultados de busqueda</label>
    <input type="hidden" name="old_wplp_post_search" value="<?php echo $wplp_post_search; ?>"/>
    <br />
    <label for="wplp_post_feed" class="selectit"><input type="checkbox" id="wplp_post_feed" name="wplp_post_feed" value="1"<?php checked($wplp_post_feed, 1); ?>/>&nbsp;Ocultar en feeds</label>
